...
window.addEventListener('DOMContentLoaded', () => { 
    ...
    // natural-killer-cell
    const naturalKillerCellAction = new TimelineLite()
    .to('.natural-killer-cell', 2, {background: '#A5001A'}, 0)
    .to('.natural-killer-cell__type .deep', 1, {fill: '#900017'}, 0)
    .to('.natural-killer-cell__type .light', 1, {fill: '#ffffff'}, 0)

    const naturalKillerCellScene = new ScrollMagic.Scene({
    ...
    // natural-killer
    const naturalKillerAction = new TimelineLite()
    .to('.natural-killer__explain--headline', 0.8, {opacity: 1, y: 0}, 0)
    .to('.natural-killer__explain--text-box-mg:nth-of-type(1)', 0.8, {opacity: 1, y: 0}, 0.4)
    .to('.natural-killer__explain--text-box-mg:nth-of-type(2)', 0.8, {opacity: 1, y: 0}, 0.6)
    .to('.natural-killer__explain--text-box-mg:nth-of-type(3)', 0.8, {opacity: 1, y: 0}, 0.8)

    const naturalKillerScene = new ScrollMagic.Scene({
    ...
    // assassin-info
    const assasinInfoOriginAction = new TimelineLite()
    .set('.assassin-info--origin--visual .illust', {opacity: 0, x: '15vw'}, 0)
    .to('.assassin-info--origin--visual', 1, {clipPath : 'polygon(0 0, 100% 0, 100% 100%, 0 80%)'}, 0.2)
    .to('.assassin-info--origin--visual .illust', 1, {opacity: 1, x: 0}, 0.2)
    .to('.assassin-info--origin--visual .typo', 0.8, {opacity: 1}, 0.6)
    .to('.assassin-info--origin--content', 1, {opacity: 1, y: 0}, 0.8)

    const assasinInfoOriginScene = new ScrollMagic.Scene({
        triggerElement: ".assassin-info--origin",
        triggerHook: 0.7
    }).setTween(assasinInfoOriginAction).addTo(ctrl);


    const assasinInfoTalentAction = new TimelineLite()
    .set('.assassin-info--talent--visual .illust', {opacity: 0, x: '10vw'}, 0)
    .to('.assassin-info--talent--visual', 1, {clipPath : 'polygon(0 15%, 100% 0, 100% 100%, 0% 100%)'}, 0.2)
    .to('.assassin-info--talent--visual .illust', 1, {opacity: 1, x: 0}, 0.2)
    .to('.assassin-info--talent--visual .talent-obj1', 0.6, {opacity: 1, x: 0}, 0.5)
    .to('.assassin-info--talent--visual .talent-obj2', 0.6, {opacity: 1, x: 0}, 0.7)
    .to('.assassin-info--talent--visual .talent-obj3', 0.6, {opacity: 1, x: 0}, 0.9)
    .to('.assassin-info--talent--visual .talent-obj4', 0.6, {opacity: 1, x: 0}, 1.1)
    .to('.assassin-info--talent--visual .typo', 0.8, {opacity: 1}, 0.6)
    .to('.assassin-info--talent--content', 1, {opacity: 1, y: 0}, 0.8)

    const tMechanismAnimation = new TimelineLite({paused: true, repeat: -1})
    .set('.t-question-mark', {scale: 0}, 0)
    .to('.t-cell-3', 1.4, {x: 150, ease: 'none'}, 0)
    .to('.cancer-cell.tarea', 1.4, {x: -120, ease: 'none'}, 0)
    ...
    .to('.t-question-mark', 0.7, {scale: 1, ease: Back.easeOut.config(3) }, 2.7)
    ...
    const assasinInfoTalentScene = new ScrollMagic.Scene({
        triggerElement: ".assassin-info--talent",
        triggerHook: 0.7
    }).setTween(assasinInfoTalentAction).addTo(ctrl)
    ...
    const assasinInfoHeroAction = new TimelineLite()
    .set('.assassin-info--hero--visual .illust', {opacity: 0, x: '10vw'}, 0)
    .to('.assassin-info--hero--visual .illust', 1, {opacity: 1, x: 0}, 0.2)
    .to('.assassin-info--hero--visual .background', 1.4, {scale: 1.4}, 0.2)
    .to('.assassin-info--hero--visual .typo', 0.8, {opacity: 1}, 0.6)
    .to('.assassin-info--hero--content', 1, {opacity: 1, y: 0}, 0.8)

    const procedureAnimation = new TimelineLite()
    .set('.procedure-nk', {scale: 0}, 0)
    .set('.procedure-cancer', {scale: 0}, 0)
    .set('.procedure-etc1', {scale: 0}, 0)
    .set('.procedure-etc2', {scale: 0}, 0)
    .set('.procedure-etc3', {scale: 0}, 0)
    .set('.procedure-etc3 .procedure__inner-text', {opacity: 0}, 0)
    ...
    .set('.procedure-step2 .procedure-line', {scaleX: 0}, 0)
    ...
    .to('.procedure-etc1', 0.6, {scale: 1}, 1.3)
    .to('.procedure-etc2', 0.6, {scale: 1}, 1.5)
    ...
    .to('.procedure-etc3', 0.6, {scale: 1}, 2.3)
    .to('.procedure-etc3 .procedure__inner-text', 0.6, {opacity: 1}, 2.3)
    ...
    const assasinInfoHeroScene = new ScrollMagic.Scene({
        triggerElement: ".assassin-info--hero",
        triggerHook: 0.7
    }).setTween(assasinInfoHeroAction).addTo(ctrl);

    const procedureScene = new ScrollMagic.Scene({
        triggerElement: ".procedure",
        triggerHook: 0.6
    }).setTween(procedureAnimation).addTo(ctrl);


    const assasinInfoVillainAction = new TimelineLite()
    .set('.assassin-info--villain--visual .illust', {opacity: 0, y: '-10vw'}, 0)
    .to('.assassin-info--villain--visual .background', 0.8, {opacity: 1}, 0.2)
    .to('.assassin-info--villain--visual .illust', 1, {opacity: 1, y: 0}, 0.2)
    .to('.assassin-info--villain--visual .typo', 0.8, {opacity: 1}, 0.6)
    .to('.assassin-info--villain--content .title', 0.8, {opacity: 1, y: 0}, 0.8)
    .to('.assassin-info--villain--content .list-area__block--item:nth-of-type(1)', 0.8, {opacity: 1, y: 0}, 1)
    .to('.assassin-info--villain--content .list-area__block--item:nth-of-type(2)', 0.8, {opacity: 1, y: 0}, 1.4)
    .to('.assassin-info--villain--content .list-area__block--item:nth-of-type(3)', 0.8, {opacity: 1, y: 0}, 1.8)

    const assasinInfoVillainScene = new ScrollMagic.Scene({
    ...
    // epilogue
    const epiloguePageScene = new TimelineLite()
    .to('.epilogue__background-illust', 1.2, {opacity: 1}, 0.5)
    .to('.epilogue__background-rain2', 1, {opacity: 1, y: 0}, 0.5)
    ...
    const epilogueScene = new ScrollMagic.Scene({
    ...
    // outro
    const outroPageScene = new TimelineLite()
    ...
    .to('.outro__inner--homepage', 1, {opacity: 1}, 1.3)
    .to('.outro__inner--quiz', 1, {opacity: 1}, 1.5)

    const outroScene = new ScrollMagic.Scene({
