...
window.addEventListener('DOMContentLoaded', () => { 
   ...
   $('.quiz__btn--finish').click( ()=>{
    ...
    const assassinContent = {
        ...
        heroAnimation(){
            ...
            .set('.procedure-etc4', {scale: 0}, 0)
            .set('.procedure-etc5', {scale: 0}, 0)
            ...
            .to('.procedure-etc4', 0.6, {scale: 1}, 2.5)
            .to('.procedure-etc5', 0.6, {scale: 1}, 2.7)
    ...
    const navi = {
        ...
        origin(){
            ...
            .set('.assassin-info__visual--character-origin', {scale: 1.5, y: 0, x: 0}, 0.2)
    ...
    const naviKeyControls = (pressKey) => {
   ...
   const pageNextScene = {
        ...
        epilogue(){
            ...
            .to('.outro__inner--video-play', 0.5, {opacity: 1}, 0.8)
        ...
        outro(){
            ...
            .set('.outro__inner--homepage', {opacity: 0}, 0)
